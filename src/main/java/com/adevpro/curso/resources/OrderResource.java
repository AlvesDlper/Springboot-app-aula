...
import com.adevpro.curso.services.OrderService;

@RestController // Anotation responsável por indicar que a classe é implementada por um
@RequestMapping(value = "/orders") // Anotation que mapeia (dá nome para) o caminho para acesso à este Classe (end point).
